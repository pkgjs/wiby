...
module.exports.getPackageJson = async function getPackageJson (owner, repo, branch) {
  try {
    ...
    const packageJson = resp.repository.object.tree.entries?.find(file => file.name === "package.json")
...
module.exports.getShas = async function getShas (owner, repo, branch) {
